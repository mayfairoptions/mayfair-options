    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="leading-none">
            <span className="block text-sm font-semibold" style={{ fontFamily: "var(--font-playfair)", color: "#ffffff" }}>
              Mayfair
            </span>
      ...
      >
        {pinnedTabs.map((l) => {
          ...
          return (
            <a
              ...
              style={{ color: active ? "#C9A96E" : "#ffffff" }}
            >
              {l.icon}
        ...
        <button
          ...
          className="flex flex-col items-center gap-1 flex-1 py-1 transition-all duration-200"
          style={{ color: drawerOpen ? "#C9A96E" : "#ffffff" }}
        >
          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 pb-4" style={{ borderBottom: "1px solid rgba(201,169,110,0.08)" }}>
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold" style={{ fontFamily: "var(--font-playfair)", color: "#ffffff" }}>Mayfair Options</span>
              </div>
            ...
            <div className="overflow-y-auto px-4 py-4 flex flex-col gap-4" style={{ maxHeight: "calc(80vh - 120px)" }}>
              <a
                ...
                style={{
                  ...
                  color: isActive(overview.href) ? "#C9A96E" : "#ffffff",
                  ...
                  {section.links.map((l) => (
                    <a
                      ...
                      style={{
                        ...
                        color: isActive(l.href) ? "#C9A96E" : "#ffffff",
